...
{
    // DTO simple para evitar problemas con tipos an�nimos y din�micos
    ...
    public class IndexModel : PageModel
    {
        ...
        private async Task<IActionResult> GridDataCoreAsync(bool mostrarEliminados = false, string? filtroTriage = null)
        {
            ...
            // 3. IDs de padres de esos hijos que no est�n ya dentro del filtro
            ...
            // 5. Arma la jerarqu�a para la grilla:
        ...
        public async Task<IActionResult> OnGetGetSintomaAsync(int id)
        {
            try
            {
                ...
                if (s == null)
                {
                    return new JsonResult(new { success = false, message = "S�ntoma no encontrado." }) { StatusCode = 404 };
                }
            ...
            catch (Exception ex)
            {
                ...
                return new JsonResult(new { success = false, message = "Error al obtener el s�ntoma." }) { StatusCode = 500 };
            }
        }
        ...
        public async Task<IActionResult> OnPostEditarSintomaAsync()
        {
            ...
            if (sintoma == null)
                return new JsonResult(new { success = false, message = "S�ntoma no encontrado." });
        ...
        public async Task<IActionResult> OnPostEliminarSintomaAsync()
        {
            ...
            if (esPadre && tieneHijos)
                return new JsonResult(new { success = false, message = "No puedes eliminar s�ntomas padre que tienen hijos. Elimina o reasigna primero sus hijos." });
            ...
            // Invariante: síntoma eliminado ⇒ su término del glosario deja de listarse.
        ...
        public async Task<IActionResult> OnPostRestaurarSintomaAsync()
        {
            ...
            // Invariante (lado reversible): restaurar el síntoma reactiva su término.
