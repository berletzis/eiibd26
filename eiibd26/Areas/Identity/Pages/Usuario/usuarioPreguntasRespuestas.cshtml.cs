...
namespace eiibd26.Areas.Identity.Pages.Usuario
{
    ...
    public class PreguntasRespuestasModel : PageModel
    {
        ...
        public class PreguntaCardVm
        {
            ...
            [MaxLength(255)]
            public string? Slug { get; set; }  // ← YA ESTÁ BIEN
        ...
        public async Task<IActionResult> OnGetAsync(int? pageNumber, int? pageSize)
        {
            ...
            var pageQ = baseQ
                .Select(p => new
                {
                    ...
                    p.Titulo,
                    p.Cuerpo,
                    Slug = p.Slug ?? "",  // ← CAMBIAR ESTA LÍNEA (agregar ?? "")
                    p.UsuarioId,
                    p.FechaCreacion,
            ...
            Preguntas = items.Select(i =>
            {
                ...
                var vm = new PreguntaCardVm
                {
                    ...
                    Slug = i.Slug ?? SlugHelper.GenerateSlug(rawTitle),  // ← AGREGAR ESTA LÍNEA
        ...
        // ===== MÉTODO CORREGIDO: Genera slug único al crear =====
