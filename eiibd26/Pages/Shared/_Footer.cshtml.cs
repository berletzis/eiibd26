...
namespace eiibd26.Pages.Shared
{
    public class _FooterPartialModel : PageModel
    {
        ...
        public List<ContenidoCategoria> Categorias3 { get; set; } = new List<ContenidoCategoria>();
        ...
        public async Task OnGetAsync()
        {
            ...
            Categorias3 = await _db.ContenidosCategorias
                .AsNoTracking()
                .Where(c => !c.Borrado
                            && c.Relevante == true
                            && (c.Sequence == 3 || c.CategoriaPadre == 3))
                .OrderBy(c => c.Orden)
                .ThenBy(c => c.Nombre)
                .ToListAsync();
        }
